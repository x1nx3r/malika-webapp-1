      ...
      <div className="container mx-auto bg-[#FAFAFA] rounded-bl-8 sm:rounded-bl-16 rounded-br-8 sm:rounded-br-16 outline outline-2 outline-[#D9D9D9] -outline-offset-2">
        <div className="flex flex-col md:flex-row items-center justify-between p-4">
          ...
          <form
            ...
            className="hidden md:block w-full max-w-[37.5rem] mx-4"
          >
            <div className="relative h-[3.75rem]">
              <input
                ...
                className="w-full h-full px-6 py-2 rounded-full outline outline-1 outline-[#03081F] -outline-offset-[0.5px] text-lg font-semibold font-['Poppins'] placeholder:text-[#666666]"
              />
              <button
                type="submit"
          ...
          {/* Mobile Search Form - Functional on mobile */}
          <form onSubmit={handleSearch} className="md:hidden w-full mb-4">
            <div className="relative">
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full h-[2.5rem] px-4 py-2 rounded-full outline outline-1 outline-[#03081F] -outline-offset-[0.5px] text-sm font-['Poppins']"
              />
              <button
                type="submit"
                className="absolute right-2 top-1/2 -translate-y-1/2 cursor-pointer bg-gray-100 w-[2rem] h-[2rem] flex items-center justify-center rounded-full"
              >
                <svg
