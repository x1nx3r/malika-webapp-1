...
function PhoneIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 20 20">
      <path fill="#F0F0F0" d="M16.8 5.7C14.4 2 9.5.9 5.7 3.2C2 5.5.8 10.5 3.2 14.2l.2.3l-.8 3l3-.8l.3.2c1.3.7 2.7 1.1 4.1 1.1c1.5 0 3-.4 4.3-1.2c3.7-2.4 4.8-7.3 2.5-11.1m-2.1 7.7c-.4.6-.9 1-1.6 1.1c-.4 0-.9.2-2.9-.6c-1.7-.8-3.1-2.1-4.1-3.6c-.6-.7-.9-1.6-1-2.5c0-.8.3-1.5.8-2q.3-.3.6-.3H7c.2 0 .4 0 .5.4c.2.5.7 1.7.7 1.8c.1.1.1.3 0 .4c.1.2 0 .4-.1.5s-.2.3-.3.4c-.2.1-.3.3-.2.5c.4.6.9 1.2 1.4 1.7c.6.5 1.2.9 1.9 1.2c.2.1.4.1.5-.1s.6-.7.8-.9s.3-.2.5-.1l1.6.8c.2.1.4.2.5.3c.1.3.1.7-.1 1" />
    </svg>
  );
}
    ...
    <div className="w-[5rem] h-[5rem] sm:w-[7rem] sm:h-[7rem] md:w-[9.375rem] md:h-[9.375rem] absolute bottom-[-1rem] sm:bottom-[-1.563rem] left-[-0.75rem] sm:left-[-1.25rem] bg-white rounded-[0.75rem] md:rounded-[1rem] flex flex-col items-center justify-center shadow-lg">
      ...
      <div className="flex mt-1 sm:mt-2">
        {[...Array(5)].map((_, index) => (
          ...
          >
            <svg className="w-[0.75rem] sm:w-[1.5rem] h-[0.75rem] sm:h-[1.5rem] absolute left-[0.125rem] sm:left-[0.1rem] top-[0.125rem] sm:top-[0.188rem] text-[#FBBC04]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
